...
titanic_train = pd.read_csv("D:/Data Science/Data/titanic_train_small.csv")
...
titanic_test.to_csv("Submission_RefinedVer3.csv", columns=['PassengerId', 'Survived'], index=False)
