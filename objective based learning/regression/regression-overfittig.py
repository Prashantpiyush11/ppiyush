#Author: Sreeni Jilla
#Linear Regression, Ridge(L2), LASSO(L1) and ElasticNet(L1+L2)
...
# X = house_train1.drop('SalePrice', 1)
# x_train, x_cv, y_train, y_cv = train_test_split(X, house_train1.log_sale_price, test_size =0.3)
# 
#==============================================================================
